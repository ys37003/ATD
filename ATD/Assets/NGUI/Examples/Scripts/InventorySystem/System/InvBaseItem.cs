...
/// <summary>
/// Inventory System 00 Base Item. Note that it would be incredibly tedious to create all items by hand, Warcraft style.
...
public class InvBaseItem
{
	public enum Slot
	{
		...
		Weapon,			// All the following elements are yours to customize 00 edit, add or remove as you desire
		Shield,
		Body,
		Shoulders,
		Bracers,
